  ...
  const highlights = [
    {
      ...
      title: "Diseño UX/UI",
      description: t("language") === "es" ? "Interfaces intuitivas y visualmente impactantes." : "Intuitive and visually striking interfaces."
    },
    {
      icon: <Code className="w-6 h-6 text-secondary" />,
      title: t("language") === "es" ? "Desarrollo Moderno" : "Modern Development",
      description: t("language") === "es" ? "Código limpio y eficiente utilizando las últimas tecnologías." : "Clean and efficient code using the latest technologies."
    },
    {
      icon: <Zap className="w-6 h-6 text-yellow-400" />,
      title: t("language") === "es" ? "Rendimiento" : "Performance",
      description: t("language") === "es" ? "Optimización al detalle para cargas ultrarrápidas." : "Detailed optimization for ultra-fast loading."
    }
  ];
